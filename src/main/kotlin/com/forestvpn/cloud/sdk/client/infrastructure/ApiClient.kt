package com.forestvpn.cloud.sdk.client.infrastructure
...
open class ApiClient(val baseUrl: String, val client: OkHttpClient = defaultClient) {
    companion object {
        ...
        const val baseUrlKey = "com.forestvpn.cloud.sdk.client.baseUrl"
    ...
    protected inline fun <reified T: Any?> responseBody(body: ResponseBody?, mediaType: String? = JsonMediaType): T? {
        ...
        if (T::class.java == File::class.java) {
            ...
            val f = java.nio.file.Files.createTempFile("tmp.com.forestvpn.cloud.sdk.client", null).toFile()
            f.deleteOnExit()
